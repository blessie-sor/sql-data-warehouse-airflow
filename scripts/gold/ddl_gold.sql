...
DDL Script: Create Gold Views
  ...
  to produce a clean, curated, business-ready dataset.
...
SELECT
    ...
    CASE WHEN cat_id = 'CO_PE' THEN COALESCE(cat, 'Components') ELSE cat END AS category,
    CASE WHEN cat_id = 'CO_PE' THEN COALESCE(subcat, 'Pedals') ELSE subcat END AS subcategory,
    pc.maintenance,
    pn.prd_cost AS cost,
